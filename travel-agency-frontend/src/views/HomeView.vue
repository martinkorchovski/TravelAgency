...
<template>
  <div>
    <!-- Hero Section -->
    <div class="relative h-[550px] flex items-center justify-center text-white"
...
/>
    ...
    <select class="border rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500">
      <option>Број лица</option>
      <option>1 лице</option>
      <option>2 лица</option>
      <option>3 лица</option>
      <option>4+ лица</option>
    </select>

 

    <button class="bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-xl px-6 py-3">
      Барај
    </button>
  </div>
</div>
...
<div class="bg-gray-50 py-16 px-6">
  <div class="max-w-6xl mx-auto">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div
        ...
        @click="router.push(`/bookings?destinationId=${dest.id}`)"
      >
        ...
        <div class="p-5">
          ...
          <div class="flex justify-between items-center mt-5">
            ...
            <button class="bg-orange-500 text-white px-5 py-2 rounded-full font-bold">
              Детали
            </button>
          </div>
        </div>
    ...
    <div class="max-w-6xl mx-auto px-6 py-16">
      ...
      <div v-if="destinations.length === 0" class="text-center text-gray-400 text-xl">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="p-4 flex items-center justify-between">
            <div>
              <p class="text-gray-500 text-sm line-clamp-1">{{ dest.description }}</p>
            </div>
  ...
  <h2 class="text-4xl font-bold mb-4">
    Подготвен за следната авантура?
  </h2>

  <p class="mb-8 text-lg">
    Изберија твојата следна дестинација и резервирај онлајн.
  </p>
